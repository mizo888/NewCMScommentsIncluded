...
?>
    <input type="text" name="comment_author" style="display: none" value="<?php echo $_SESSION['username']; ?> ">
    <input type="text" name="post_user" style="display: none" value="<?php echo $_SESSION['user_id']; ?> ">
<?php } else { ?>

    <input type="text" name="comment_author" style="display: none" value="">
    <input type="text" name="post_user" style="display: none" value="">
    <?php } ?>
    ...
    <div class="comments_display">
        ...
        <div class="comments_body">
            <h4 class="comments_heading"><i class="comment_d">Name: </i> <span><?php echo $comment_author;   ?></span>
                <i class="comment_d">Date: </i> <span><?php echo $comment_date;   ?></span> 
                <!-- Show/hide delete button if person is admin or not -->
                <?php
                if(isset($_SESSION['username'])){
                if($_SESSION['role'] === 'admin'){
                ?>

                <i class="comment_d">Delete: </i><?php echo" <span><a id='delete_comment_admin' class='material-icons' href='admin/comments.php?delete={$comment_id}'>delete</a></span>"; ?>
