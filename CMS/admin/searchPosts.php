...
if(!empty($_POST)){
      ...
      // $query ="SELECT * FROM posts WHERE 1=1 AND concat(post_title, ';', post_content) like '%" . $aKeyword[0] . "%'";
      ...
      $query .= " FROM posts ";
      $query .= " LEFT JOIN users ON posts.post_user = users.user_id WHERE 1=1 AND concat(post_title, ';', post_content) like '%" . $aKeyword[0] . "%' ";
